...
find_package(Qt6 6.4 COMPONENTS Core Gui Network REQUIRED)
...
if(FREECIV_ENABLE_NLS)
  ...
  add_subdirectory(${CMAKE_SOURCE_DIR}/engine/translations/core)
  add_subdirectory(${CMAKE_SOURCE_DIR}/engine/translations/nations)
  ...
  if (FREECIV_BUILD_TOOLS EQUAL ON)
    add_subdirectory(${CMAKE_SOURCE_DIR}/engine/translations/ruledit)
...
add_subdirectory(${CMAKE_SOURCE_DIR}/engine/dependencies/tolua-5.2) # Will build the program if not found.
add_subdirectory(${CMAKE_SOURCE_DIR}/engine/dependencies/sol2)

# backward-cpp
include(FreecivBackward)

# Compression
# Ubuntu 24.04 provides KF5Archive (libkf5archive-dev), not KF6Archive
...
if (FREECIV_ENABLE_CLIENT
  ...
  add_subdirectory(${CMAKE_SOURCE_DIR}/engine/dependencies/cvercmp)
endif()

# GUI dependencies
# GUI dependencies - removed for mobile
# if (FREECIV_ENABLE_CLIENT
#     OR FREECIV_ENABLE_FCMP_QT
