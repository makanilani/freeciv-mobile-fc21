...
QT.network.enabled_features = ssl dtls ocsp http udpsocket networkproxy socks5 networkinterface networkdiskcache brotli localserver dnslookup topleveldomain
QT.network.disabled_features = getifaddrs ipv6ifname securetransport schannel sctp gssapi sspi
QT_CONFIG += ssl dtls ocsp http udpsocket networkproxy socks5 networkinterface networkdiskcache brotli localserver dnslookup topleveldomain
QT_MODULES += network
