...
set_target_properties(Qt6::syncqt PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/Qt6/bin/syncqt"
  )
...
set_target_properties(Qt6::moc PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/Qt6/bin/moc"
  )
...
set_target_properties(Qt6::rcc PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/Qt6/bin/rcc"
  )
...
set_target_properties(Qt6::tracepointgen PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/Qt6/bin/tracepointgen"
  )
...
set_target_properties(Qt6::tracegen PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/Qt6/bin/tracegen"
  )
...
set_target_properties(Qt6::cmake_automoc_parser PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/Qt6/bin/cmake_automoc_parser"
  )
...
set_target_properties(Qt6::qlalr PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/Qt6/bin/qlalr"
  )
...
set_target_properties(Qt6::qtpaths PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/Qt6/bin/qtpaths"
  )
...
set_target_properties(Qt6::androiddeployqt PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/Qt6/bin/androiddeployqt"
  )
...
set_target_properties(Qt6::androidtestrunner PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/Qt6/bin/androidtestrunner"
  )
...
set_target_properties(Qt6::qmake PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/Qt6/bin/qmake"
  )
