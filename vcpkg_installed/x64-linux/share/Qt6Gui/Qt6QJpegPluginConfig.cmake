...
if (NOT QT_NO_CREATE_TARGETS)
    ...
    if(EXISTS "${CMAKE_CURRENT_LIST_DIR}/Qt6QJpegPluginDependencies.cmake")
        include("${CMAKE_CURRENT_LIST_DIR}/Qt6QJpegPluginDependencies.cmake")
    else()
        set(QJpegPlugin_FOUND TRUE)
    endif()

    if(QJpegPlugin_FOUND)
        include("${CMAKE_CURRENT_LIST_DIR}/Qt6QJpegPluginTargets.cmake")
        include("${CMAKE_CURRENT_LIST_DIR}/Qt6QJpegPluginAdditionalTargetInfo.cmake")
    endif()
endif()
