...
if (NOT QT_NO_CREATE_TARGETS)
    ...
    if(EXISTS "${CMAKE_CURRENT_LIST_DIR}/Qt6QICOPluginDependencies.cmake")
        include("${CMAKE_CURRENT_LIST_DIR}/Qt6QICOPluginDependencies.cmake")
    else()
        set(QICOPlugin_FOUND TRUE)
    endif()

    if(QICOPlugin_FOUND)
        include("${CMAKE_CURRENT_LIST_DIR}/Qt6QICOPluginTargets.cmake")
        include("${CMAKE_CURRENT_LIST_DIR}/Qt6QICOPluginAdditionalTargetInfo.cmake")
    endif()
endif()
