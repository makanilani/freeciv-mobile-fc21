...
if (NOT QT_NO_CREATE_TARGETS)
    ...
    if(EXISTS "${CMAKE_CURRENT_LIST_DIR}/Qt6QEvdevMousePluginDependencies.cmake")
        include("${CMAKE_CURRENT_LIST_DIR}/Qt6QEvdevMousePluginDependencies.cmake")
    else()
        set(QEvdevMousePlugin_FOUND TRUE)
    endif()

    if(QEvdevMousePlugin_FOUND)
        include("${CMAKE_CURRENT_LIST_DIR}/Qt6QEvdevMousePluginTargets.cmake")
        include("${CMAKE_CURRENT_LIST_DIR}/Qt6QEvdevMousePluginAdditionalTargetInfo.cmake")
    endif()
endif()
