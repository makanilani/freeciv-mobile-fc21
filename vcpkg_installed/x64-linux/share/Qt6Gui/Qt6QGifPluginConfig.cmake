...
if (NOT QT_NO_CREATE_TARGETS)
    ...
    if(EXISTS "${CMAKE_CURRENT_LIST_DIR}/Qt6QGifPluginDependencies.cmake")
        include("${CMAKE_CURRENT_LIST_DIR}/Qt6QGifPluginDependencies.cmake")
    else()
        set(QGifPlugin_FOUND TRUE)
    endif()

    if(QGifPlugin_FOUND)
        include("${CMAKE_CURRENT_LIST_DIR}/Qt6QGifPluginTargets.cmake")
        include("${CMAKE_CURRENT_LIST_DIR}/Qt6QGifPluginAdditionalTargetInfo.cmake")
    endif()
endif()
